...
import com.test.dockertest.exception.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    /**
     * [CustomException] WnbtRestException 경우 발생
     *
     * @param ex WnbtRestException
     * @return ResponseEntity<ErrorResponse>
     */
    @ExceptionHandler(WnbtRestException.class)
    protected final ResponseEntity<ErrorResponse> handleAllExceptions(WnbtRestException ex) {
